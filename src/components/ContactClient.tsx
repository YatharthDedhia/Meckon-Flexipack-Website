        ...
        <Reveal>
          <div className="bg-[var(--brand-red)] rounded-2xl p-8 md:p-10 shadow-xl">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              {status && <p className="rounded-lg bg-white/15 px-4 py-2 text-center text-sm text-white">{status}</p>}
            </form>
          </div>
        </Reveal>
            ...
            <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-md">
              ...
              <div className="flex flex-col gap-5">
                {contacts.company.address && (
                  <a href="https://maps.app.goo.gl/4cFg6ZwCo3zQYXcc9" target="_blank" rel="noopener noreferrer" className="group flex items-start gap-4">
                    ...
                    <p className="text-gray-600 leading-relaxed group-hover:text-[var(--brand-red)] transition-colors">{contacts.company.address}</p>
                  </a>
                )}
