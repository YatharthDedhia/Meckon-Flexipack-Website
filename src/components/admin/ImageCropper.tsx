      ...
      <div className="flex flex-col gap-3 bg-white px-6 py-4">
        <div className="flex flex-col items-center gap-3 sm:flex-row">
          ...
          <div className="flex items-center gap-2 sm:ml-auto">
            <span className={`text-sm font-semibold ${tooSmall ? 'text-[var(--brand-red)]' : 'text-emerald-600'}`}>
        ...
        <div className="flex justify-center gap-3 sm:justify-end">
          <button onClick={onCancel} className="rounded-full px-5 py-2 text-sm font-semibold text-gray-500 hover:text-gray-800">
            Cancel
          </button>
